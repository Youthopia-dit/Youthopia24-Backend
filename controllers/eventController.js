...
const dummyEvents = [
    {
        ...
        event_description: "A day-long event featuring workshops, coding competitions, and tech talks by industry leaders.",
    ...
    },
    {
        ...
        event_description: "A vibrant cultural festival showcasing various art forms.",
...
exports.createEvent = async (req, res) => {
    ...
    for (const price of prices) {
      if (!price.teamSize || !price.priceDit || !price.priceNonDit) {
        return res.status(400).json({ message: 'Each price entry must include teamSize, priceDit, and priceNonDit.' });
      }
    }
